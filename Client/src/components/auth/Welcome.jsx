...
const Welcome = ({ order, order1, text, className = "" }) => {
  return (
    <>
      <div
        className={`relative order-${order} md:order-${order1} hidden md:block w-full md:w-1/2 sm:min-h-[40vh] md:min-h-screen bg-cover bg-center text-white ${className}`}
