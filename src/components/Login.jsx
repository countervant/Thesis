...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        <div className="absolute inset-0 bg-[rgba(224,77,175,0.7)]" />
      ...
      <div className="w-1/2 bg-gray-100 flex flex-col items-center justify-center px-12">
        <img src={logo} alt="CLIENTRA" className="w-24 h-24 mb-8 object-contain" />
        <h2 className="text-3xl font-Bruno Ace SC">LOG IN</h2>
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="flex justify-between text-sm font-medium text-pink-500 mt-6">
